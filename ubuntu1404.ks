...
# for STATIC IP: uncomment and configure
 network --device=eth0 --bootproto=static --ip=192.168.100.145 --netmask=255.255.255.0 --gateway=192.168.100.1 --nameserver=192.168.100.71 --noipv6 --hostname=testubuntu
